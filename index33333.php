...
class RequestHandlerClient
{
    ...
    public function run()
    {
        ...
        $headers['auth']['clientId'] = 3575;
        $headers['auth']['clientCompany'] = "dcJWAeznRSUsTOKDlgsg";
        $headers['auth']['clientSecret'] = "MzU3NWRjSldBZXpuUlNVc1RPS0RsZ3NnY2U2NmY2ZTZmOWRlZjUxMGFjNDBiYTJlNjVjMmFjZGEwMTQyZmZhZQ==";
