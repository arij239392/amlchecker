...
<html>
	<head>
		...
		<title>Bytesailecta : Terms of service</title>
		<meta property="og:image" content="../site-logo.svg" />
		<meta name="author" content="Bytesailecta : Terms of service"/>
		<meta property="og:title" content="Bytesailecta : Terms of service" />
		
		<meta property="og:description" content="Bytesailecta : Terms of service" />
		<meta name="description" content="Bytesailecta : Terms of service" />
	...
	<button class="menu-btn" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasScrolling" aria-controls="offcanvasScrolling">	<svg
	...
	<div class="offcanvas offcanvas-start" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1" id="offcanvasScrolling" aria-labelledby="offcanvasScrollingLabel">
		...
		<div class="container">
			...
			<ul class="nav-list">
				...
				<li class="nav-item">
					<a class="nav-item-link" href="../touch-base/">Contact us</a>
				</li>
			</ul>
			
			<div class="menu-penci">
				<h4 class="menu-title">
					<span class="inner-arrow">Services</span>
				</h4>
				<ul class="menu-bog-list">
					
					<li class="menu-bog-item">
						<a href="../analytical-and-reporting-systems-from-bytesailecta/" class="side-item">
							<div class="side-image">
								<img src="../service-images/ALONG-Program-377d7-2.jpg" alt="GUI development with PyQt and Python for your business" />
							</div>
							<div class="side-item-text">
								<h4>Analytical and reporting systems from Bytesailecta</h4>
							</div>
						</a>
					</li>
					...
					<li class="menu-bog-item">
						<a href="../effective-cms-for-your-business-from-bytesailecta/" class="side-item">
							<div class="side-image">
								<img src="../service-images/ALONG_Program_8c436_3.jpg" alt="Analytical and reporting systems from Bytesailecta" />
							</div>
							<div class="side-item-text">
								<h4>Effective CMS for your business from Bytesailecta</h4>
							</div>
						</a>
					</li>
					...
					<li class="menu-bog-item">
						<a href="../keep-your-software-secure-with-bytesailecta/" class="side-item">
							<div class="side-image">
								<img src="../service-images/ALONG_Program_2024-10-13_4.jpg" alt="Effective CMS for your business from Bytesailecta" />
							</div>
							<div class="side-item-text">
								<h4>Keep your software secure with Bytesailecta</h4>
							</div>
						</a>
					</li>
					...
					<li class="menu-bog-item">
						<a href="../effective-marketing-and-sales-management/" class="side-item">
							<div class="side-image">
								<img src="../service-images/ALONG-Program-23c02-5.jpg" alt="Keep your software secure with Bytesailecta" />
							</div>
							<div class="side-item-text">
								<h4>Effective marketing and sales management</h4>
							</div>
						</a>
					</li>
			...
			<div class="menu-footer">
				<div class="copyright">	
					<span style="padding-right: 10px;">Copyright</span><span>&#169 </span> <span class="yearCopycategory--panelgx" style="margin-right: 10px;"></span> 
					Bytesailecta			
				</div>
			</div>
			  </div>
	...
	<div class="menu-head">
		...
		<div class="container">
			...
			<ul class="nav-list mt-5">
				...
				<li class="nav-item">
					<a class="nav-item-link" href="../about-company/">About Us</a>
				</li>
				<li class="nav-item">
					<a class="nav-item-link" href="../touch-base/">Contact us</a>
				</li>
			...
			<div class="menu-penci">
				...
				<ul class="menu-bog-list">
					...
					<li class="menu-bog-item">
						<a href="../analytical-and-reporting-systems-from-bytesailecta/" class="side-item">
							<div class="side-image">
								<img src="../service-images/ALONG-Program-377d7-2.jpg" alt="Effective marketing and sales management" />
							</div>
							<div class="side-item-text">
								<h4>Analytical and reporting systems from Bytesailecta</h4>
							</div>
					...
					<li class="menu-bog-item">
						<a href="../effective-cms-for-your-business-from-bytesailecta/" class="side-item">
							<div class="side-image">
								<img src="../service-images/ALONG_Program_8c436_3.jpg" alt="GUI development with PyQt and Python for your business" />
							</div>
							<div class="side-item-text">
								<h4>Effective CMS for your business from Bytesailecta</h4>
							</div>
					...
					<li class="menu-bog-item">
						<a href="../keep-your-software-secure-with-bytesailecta/" class="side-item">
							<div class="side-image">
								<img src="../service-images/ALONG_Program_2024-10-13_4.jpg" alt="Analytical and reporting systems from Bytesailecta" />
							</div>
							<div class="side-item-text">
								<h4>Keep your software secure with Bytesailecta</h4>
							</div>
					...
					<li class="menu-bog-item">
						<a href="../effective-marketing-and-sales-management/" class="side-item">
							<div class="side-image">
								<img src="../service-images/ALONG-Program-23c02-5.jpg" alt="Effective CMS for your business from Bytesailecta" />
							</div>
							<div class="side-item-text">
								<h4>Effective marketing and sales management</h4>
							</div>
			...
			<div class="menu-footer">
				<div class="copyright">	
					<span style="padding-right: 10px;">Copyright</span><span>&#169</span> <span class="yearCopywrapper-tooltipjk" style="margin-right: 10px;"></span> 
					Bytesailecta			
				</div>
			</div>
			</div>
...
<div class="main-wrapper">
	<section class="section-page">
		<div class="overlay-page background-page"></div>
    ...
    <div class="container">
        <h1 class="title">Bytesailecta : Terms of service</h1>
        <div class="privacy-box">
            <h3>AGREEMENT TO OUR LEGAL TERMS</h3>

<p>We are Web site ( 'Company', 'we', 'us', or 'our' ) .</p>

<p>We operate the website Web site (the 'Site'), as well as any other related products and services that refer or link to these legal terms (the 'Legal Terms') (collectively, the 'Services').</p>

<p>__________</p>

<p>You can contact us by email at  or by mail to  .</p>

<p>These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ('you'), and Web site, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</p>

<p>We will provide you with prior notice of any scheduled changes to the Services you are using. The modified Legal Terms will become effective upon posting or notifying you by , as stated in the email message. By continuing to use the Services after the effective date of any changes, you agree to be bound by the modified terms.</p>
...
<div style="display: flex; flex-direction: column; gap: 5px;">
    ...
    <a href="#purchases">6. PURCHASES AND PAYMENT</a>
    <a href="#returnyes">7. RETURN/REFUNDS POLICY</a>
    <a href="#software">8. SOFTWARE</a>
    <a href="#prohibited">9. PROHIBITED ACTIVITIES</a>
    <a href="#ugc">10. USER GENERATED CONTRIBUTIONS</a>
    <a href="#license">11. CONTRIBUTION LICENCE</a>
    <a href="#reviews">12. GUIDELINES FOR REVIEWS</a>
    <a href="#socialmedia">13. SOCIAL MEDIA</a>
    <a href="#thirdparty">14. THIRD-PARTY WEBSITES AND CONTENT</a>
    <a href="#sitemanage">15. SERVICES MANAGEMENT</a>
    <a href="#ppyes">16. PRIVACY POLICY</a>
    <a href="#dmca">17. DIGITAL MILLENNIUM COPYRIGHT ACT (DMCA) NOTICE AND POLICY</a>
    <a href="#terms">18. TERM AND TERMINATION</a>
    <a href="#modifications">19. MODIFICATIONS AND INTERRUPTIONS</a>
    <a href="#law">20. GOVERNING LAW</a>
    <a href="#disputes">21. DISPUTE RESOLUTION</a>
    <a href="#corrections">22. CORRECTIONS</a>
    <a href="#disclaimer">23. DISCLAIMER</a>
    <a href="#liability">24. LIMITATIONS OF LIABILITY</a>
    <a href="#indemnification">25. INDEMNIFICATION</a>
    <a href="#userdata">26. USER DATA</a>
    <a href="#electronic">27. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</a>
...
solely for your personal, non-commercial use or internal business purpose.</p>

<p>Except as set out in this section or elsewhere in our Legal Terms, no part of the Services and no Content or Marks may be copied, reproduced, aggregated, republished, uploaded, posted, publicly displayed, encoded, translated, transmitted, distributed, sold, licensed, or otherwise exploited for any commercial purpose whatsoever, without our express prior written permission.</p>

<p>If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: . If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.</p>
...
<p>You are responsible for what you post or upload: By sending us Submissions and/or posting Contributions through any part of the Services or making Contributions accessible through the Services by linking your account through the Services to any of your social networking accounts, you:
...
You are solely responsible for your Submissions and/or Contributions and you expressly agree to reimburse us for any and all losses that we may suffer because of your breach of (a) this section, (b) any third party’s intellectual property rights, or (c) applicable law.</p>
...
<h3 id="purchases">6. PURCHASES AND PAYMENT</h3>
...
<h3 id="returnyes">7. RETURN/REFUNDS POLICY</h3>
...
<h3 id="prohibited">9. PROHIBITED ACTIVITIES</h3>
...
<h3 id="ugc">10. USER GENERATED CONTRIBUTIONS</h3>
...
<h3 id="license">11. CONTRIBUTION LICENCE</h3>
...
<h3 id="reviews">12. GUIDELINES FOR REVIEWS</h3>
...
<h3 id="socialmedia">13. SOCIAL MEDIA</h3>
...
<h3 id="thirdparty">14. THIRD-PARTY WEBSITES AND CONTENT</h3>
...
<h3 id="sitemanage">15. SERVICES MANAGEMENT</h3>
...
<h3 id="ppyes">16. PRIVACY POLICY</h3>

<p>We care about data privacy and security. Please review our <a target="_blank" href="../privacyPolicy/">Privacy Policy</a>. By using the Services, you agree to be bound by our Privacy Policy, which is incorporated into these Legal Terms. Please be advised the Services are hosted in the United Kingdom. If you access the Services from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in the United Kingdom, then through your continued use of the Services, you are transferring your data to the United Kingdom, and you expressly consent to have your data transferred to and processed in the United Kingdom.</p>

<h3 id="dmca">17. DIGITAL MILLENNIUM COPYRIGHT ACT (DMCA) NOTICE AND POLICY</h3>
...
<h3 id="terms">18. TERM AND TERMINATION</h3>
...
<h3 id="modifications">19. MODIFICATIONS AND INTERRUPTIONS</h3>
...
<h3 id="law">20. GOVERNING LAW</h3>

<p>These Legal Terms are governed by and interpreted following the laws of England, and the United Nations Convention of Contracts for the International Sale of Goods is expressly applied. If your habitual residence is in the EU, the USA, or any of the other 62 countries party to the convention, you additionally possess the protection provided to you by obligatory provisions of the law in your country of residence. This means that you may make a claim to defend your consumer protection rights in regard to these Legal Terms in England, or in any country party to the convention where you reside.</p>

<h3 id="disputes">21. DISPUTE RESOLUTION</h3>

<h5>Binding Arbitration</h5>

<p>If you are a resident of the European Union, any disputes arising from or related to these Legal Terms shall be resolved by an arbitrator appointed in accordance with the Arbitration and Internal Rules of the European Court of Arbitration, which is a part of the European Centre of Arbitration based in Strasbourg. The venue for such arbitration shall be England. The predominant language of the proceedings shall be english. The governing law for these proceedings shall be the laws of England.</p>

<p>If you are a resident of the United States, disputes shall be resolved by arbitration in the United States. The governing law for these proceedings shall be the laws of USA.</p>

<p>For residents of any other country, the arbitration venue and procedures shall be the same as those stipulated for residents of the European Union.</p>
...
<h3 id="corrections">22. CORRECTIONS</h3>

<p>There may be information on the Services that contains typographical errors, inaccuracies, or omissions, including descriptions, pricing, availability, and various other information. We reserve the right to correct any errors, inaccuracies, or omissions and to change or update the information on the Services at any time, without prior notice.</p>

<h3 id="disclaimer">23. DISCLAIMER</h3>
...
<h3 id="liability">24. LIMITATIONS OF LIABILITY</h3>
...
<h3 id="indemnification">25. INDEMNIFICATION</h3>
...
<h3 id="california">28. CALIFORNIA USERS AND RESIDENTS</h3>

<p>If any complaint with us is not satisfactorily resolved, you can contact the Complaint Assistance Unit of the Division of Consumer Services of the California Department of Consumer Affairs in writing at 1625 North Market Blvd., Suite N 112, Sacramento, California 95834 or by telephone at (800) 952-5210 or (916) 445-1254.</p>

<h3 id="misc">29. MISCELLANEOUS</h3>
...
<h3 id="contact">30. CONTACT US</h3>
